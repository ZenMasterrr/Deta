  ...
  const stats = [
    {
      ...
      description: 'using advanced probabilistic models'
    },
    {
      value: 'Live',
      label: 'Competitor Intel',
      description: 'powered by OSINT deep search'
    },
    {
      value: 'Auditable',
      label: 'Transparency',
      description: 'with full system event logs'
    },
  ];

  const features = [
    {
      title: 'AI Campaign Simulation',
      description: 'Sophisticated Python-based simulation engine that predicts ROI, engagement, and conversions based on real-world market factors.',
      placeholder: 'AI Simulation',
      points: [
        'Monte Carlo & Probabilistic modeling',
        'Daily budget & revenue breakdown',
        'Dynamic market event injection',
        'Detailed financial projections'
      ]
    },
    {
      title: 'OSINT Competitor Scouting',
      description: 'Automated Open Source Intelligence (OSINT) engine that monitors competitor activity in real-time.',
      placeholder: 'OSINT Radar',
      points: [
        'Google News Deep Search integration',
        'Real-time competitor headline extraction',
        'Automated strategic response suggestions',
        'Live market price fluctuation tracking'
      ]
    },
    {
      title: 'Persistent Dashboard',
      description: 'Comprehensive Command Center for tracking multiple campaigns and managing user profiles.',
      placeholder: 'Command Center',
      points: [
        'User authentication & persistence',
        'Multi-campaign status management (Pause/Resume)',
        'Live system trace logging',
  ...
  const designProcess = [
    {
      ...
      description: 'Identified the lack of real-time, risk-free training environments for digital marketers.'
    },
    {
      title: 'Architecture Planning',
      description: 'Designed a decoupled Microservices-ready architecture using Docker, separating the Simulation Engine (Python) from the UI (React).'
    },
    {
      title: 'Algorithm Development',
      description: 'Engineered the core simulation logic to account for uniqueness degradation, competitor saturation, and ad spend efficiency.'
    },
    {
      title: 'OSINT Integration',
      description: 'Implemented web scraping and RSS feed analysis to inject real-world chaos signals into the simulation.'
    },
    {
      title: 'UI/UX Polish',
      description: 'Built a "Cyberpunk" themed interface to gamify the experience while maintaining professional data density.'
    }
  ];
  ...
  const challenges = [
    {
      ...
      description: 'Making the fake numbers feel real and responsive to user actions.',
      solution: 'Implemented complex decay functions and random market event generators (e.g. "Viral Trend", "Competitor Scandal") to create dynamic variance.'
    },
    {
      title: 'Real-time OSINT',
      description: 'Scraping competitor news without getting blocked or slowed down.',
      solution: 'Utilized Google News RSS feeds with specific search operators for lightweight, reliable, and targeted intelligence gathering.'
    },
    {
      title: 'State Synchronization',
      description: 'Keeping the Frontend Dashboard in sync with the backend daily scheduler.',
      solution: 'Implemented a robust polling mechanism with optimistic UI updates and state persistence in PostgreSQL to ensure seamless user sessions.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        <section className="relative mb-24">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              Marketing Lab - AI-PoweredOSINT Simulator
            </h1>
            <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-blue-500 rounded-full mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              A professional-grade simulation platform integrating real-time Open Source Intelligence (OSINT) with probabilistic ROI modeling for advanced marketing strategy testing.
            </p>
          </motion.div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-12 leading-relaxed">
                Marketing Lab is not just a dashboard—it's a living simulation environment. It allows marketers to define products, set budgets, and choose strategies, then pits them against AI-driven competitors and real-world market forces.
                Powered by a Python backend and a React frontend, it features a custom "OSINT Engine" that scrapes live news to inject volatility into the simulation, ensuring no two campaigns are ever the same.
              </p>
              ...
              <div className="mb-12">
                ...
                <p className="mt-4 text-gray-400 text-sm">
                  Walkthrough of the Marketing Lab platform showcasing campaign creation, Real-time Simulation, and User Dashboard.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="mt-6 text-gray-400 text-sm text-center max-w-3xl mx-auto">
                  The platform is containerized using Docker, orchestrating a FastAPI backend (with AsyncPG/SQLAlchemy) and a Vite+React frontend.
                  It uses APScheduler for the daily simulation ticks and BeautifulSoup for real-time data gathering.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section className="py-16 bg-gray-900/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div>
                <h3 className="text-2xl font-bold mb-4 text-green-400">1. Data Visualization</h3>
